  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] p-3 md:p-8">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center mb-8 gap-6">
        ...
        <button onClick={() => openEditModal()} className="w-full md:w-auto bg-[#0d6efd] text-white px-6 py-2.5 rounded-md text-xs font-bold flex items-center justify-center gap-2 hover:bg-[#0b5ed7] transition-all shadow-sm"><Plus size={16} /> ADD SERVICE</button>
      </div>
          ...
          <div className="bg-white rounded-lg w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-gray-200">
            ...
            <div className="p-6 space-y-5">
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full border border-gray-300 rounded px-4 py-2 text-sm focus:ring-2 focus:ring-blue-100 outline-none transition-all"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    type="number" 
                    className="w-full border border-gray-300 rounded px-4 py-2 text-sm focus:ring-2 focus:ring-blue-100 outline-none"
                ...
                <div>
                  ...
                  <div className="w-full bg-[#f1fcf4] border border-[#e3f7e9] text-[#198754] rounded px-4 py-2 text-xs font-bold text-center uppercase tracking-wide">Live</div>
                </div>
              </div>
              ...
              <div>
                ...
                <input 
                  type="text" 
                  className="w-full border border-gray-300 rounded px-4 py-2 text-sm outline-none focus:ring-2 focus:ring-blue-100"
              ...
              <div>
                ...
                <textarea 
                  rows="3"
                  className="w-full border border-gray-300 rounded px-4 py-2 text-sm outline-none resize-none focus:ring-2 focus:ring-blue-100"
            ...
            <div className="px-6 py-4 border-t border-gray-200 flex justify-end gap-2 bg-gray-50/50">
              <button 
                ...
                className="bg-[#6c757d] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#5a6268] transition-all"
              >
                Close
              </button>
              <button 
                onClick={closeAndSaveModal} 
                className="bg-[#0d6efd] text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-[#0b5ed7] transition-all shadow-sm"
              >
                Update Service
              </button>
            </div>
      ...
      {/* BOTTOM CONFIGS */}
      <div className="max-w-6xl mx-auto mt-10 grid grid-cols-1 lg:grid-cols-2 gap-6 pb-10">
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <h3 className="text-xs font-bold text-gray-400 uppercase mb-5 flex items-center gap-2 tracking-widest">Service Fees</h3>
          <div className="grid grid-cols-2 gap-4">
             <div className="space-y-1"><label className="text-[10px] text-gray-500 font-bold block">Delivery Fee</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-xs">₱</span><input type="number" value={fees.delivery_fee} onChange={e => setFees({...fees, delivery_fee: e.target.value})} className="w-full border border-gray-200 rounded px-8 py-2 text-sm font-bold text-gray-700 outline-none"/></div></div>
             <div className="space-y-1"><label className="text-[10px] text-gray-500 font-bold block">Heavy Garment</label><div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-bold text-xs">₱</span><input type="number" value={fees.heavy_garment_fee} onChange={e => setFees({...fees, heavy_garment_fee: e.target.value})} className="w-full border border-gray-200 rounded px-8 py-2 text-sm font-bold text-gray-700 outline-none"/></div></div>
          </div>
        </div>
        <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
          <h3 className="text-xs font-bold text-gray-400 uppercase mb-5 flex items-center gap-2 tracking-widest">Allowed Areas</h3>
          <textarea value={serviceAreas} onChange={e => setServiceAreas(e.target.value)} className="w-full border border-gray-200 rounded px-4 py-2 text-xs font-medium resize-none min-h-[85px] outline-none" placeholder="Mambaling, Basak San Nicolas..." />
        </div>
      </div>
